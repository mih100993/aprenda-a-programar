...
// Escreva depois dos ':' se vai entrar no 'if' ou no 'else' ('if' se entrar no 'if' e 'else' se entrar no 'else'): Vai entrar no IF devido ao valor da variável 'a' ser 10.
if (a == 10) {
...
// Escreva depois dos ':' se vai entrar no 'if' ou no 'else' ('if' se entrar no 'if' e 'else' se entrar no 'else'): Vai entrar no ELSE devido ao valor de 'a' não maior do que 10.
if (a > 10) {
...
// Escreva depois dos ':' se vai entrar no 'if' ou no 'else' ('if' se entrar no 'if' e 'else' se entrar no 'else'): Vai entrar no IF devido o valor ser igual a 10.
if (10 <= a) {
...
// Escreva depois dos ':' se vai entrar no 'if' ou no 'else' ('if' se entrar no 'if' e 'else' se entrar no 'else'): Vai entrar no IF devido ao valor de 'b' ser TRUE.
if (b == true) {
...
// Escreva depois dos ':' se vai entrar no 'if' ou no 'else' ('if' se entrar no 'if' e 'else' se entrar no 'else'): Vai entrar no ELSE devido ao valor do 'c' ser None.
if (c) {
...
// Escreva depois dos ':' se vai entrar no 'if' ou no 'else' ('if' se entrar no 'if' e 'else' se entrar no 'else'): Vai entrar no IF devido aos valores atribuidos na variável 'd'.
if (d) {
...
// Escreva depois dos ':' se vai entrar no 'if' ou no 'else' ('if' se entrar no 'if' e 'else' se entrar no 'else'): Vai entrar no IF devido ao valor do primeiro index da variável 'd'.
if (d[0] == 1) {
...
// Escreva depois dos ':' se vai entrar no 'if' ou no 'else' ('if' se entrar no 'if' e 'else' se entrar no 'else'): Vai entrar no ELSE devido ao index 1 ter o valor 2.
if (d[1] == 1) {
...
// Escreva depois dos ':' se vai entrar no 'if' ou no 'else' ('if' se entrar no 'if' e 'else' se entrar no 'else'): Vai entrar no IF devido a variável 'e' ser uma string.
if (typeof(e) == 'string') {
